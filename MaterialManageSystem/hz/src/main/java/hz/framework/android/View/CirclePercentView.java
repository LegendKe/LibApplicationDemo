...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStripeWidth = a.getDimension(R.styleable.CirclePercentView_stripeWidth, getResources().getDimensionPixelSize(R.dimen.px36));
        ...
        mBigColor = a.getColor(R.styleable.CirclePercentView_bigColor,0xfff2f2f2);
        mCenterTextSize = a.getDimensionPixelSize(R.styleable.CirclePercentView_centerTextSize, (int) getResources().getDimensionPixelSize(R.dimen.px36));
        mRadius = a.getDimensionPixelSize(R.styleable.CirclePercentView_circle_radius, (int) getResources().getDimensionPixelSize(R.dimen.px100));
    }
