 ...
 *
 */
public class AutoHiddenHintEditText extends EditText {
	// 输入表情前的光标位置
...
//								resetText = true;
//								Toast.makeText(getContext(), "不支持输入Emoji表情符号",
...
//			});
	 ...
	 * @param defStyle
	 */
	public AutoHiddenHintEditText(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs
	 */
	public AutoHiddenHintEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	 ...
	 * @param context
	 */
	public AutoHiddenHintEditText(Context context) {
		super(context);
		init();
	}
