package hz.framework.android.http;
...
public class HttpClient {
    ...
    public static boolean isNetworkAvailable() {
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) BaseApplication.app.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static void get(String url, Map<String, String> param, final HttpResponseHandler httpResponseHandler) {
        if (!isNetworkAvailable()) {
            Toast.makeText(BaseApplication.app, "网络异常", Toast.LENGTH_SHORT).show();
            return;
        }
