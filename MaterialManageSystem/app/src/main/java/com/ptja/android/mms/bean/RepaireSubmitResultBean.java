...
public class RepaireSubmitResultBean implements Serializable {
    ...
    public static class ResponseBean  implements Serializable{
        private String maintenance_log_id;
        ...
        public String getMaintenance_log_id() {
            return maintenance_log_id;
        }

        public void setMaintenance_log_id(String maintenance_log_id) {
