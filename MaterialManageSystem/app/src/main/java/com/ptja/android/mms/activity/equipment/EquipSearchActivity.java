...
public class EquipSearchActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        }, "装备搜索", "确定", 0, 0,new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                search();
            }
                ...
                try {
                    ...
                    if (response.getInt("code") == 0) {
                        if ((response.getJSONObject("response").get("data") instanceof org.json.JSONArray)) {
                            ...
                            Intent intnet = new Intent(getApplicationContext(),EquipListActivity.class);
    ...
    @OnClick({R.id.equip_type, R.id.equip_status_layout, R.id.equip_store_location, R.id.equip_in_date})
